...
> Calculate the [standard deviation][standard-deviation] of an array ignoring `NaN` values and using a one-pass trial mean algorithm.
...
```javascript
nanstdevch = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-array-nanstdevch@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-array-nanstdevch/tags). For example,

```javascript
nanstdevch = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-array-nanstdevch@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var nanstdevch = require( 'path/to/vendor/umd/stats-array-nanstdevch/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-array-nanstdevch@umd/browser.js"></script>
```
...
#### nanstdevch( x\[, correction] )

Computes the [standard deviation][standard-deviation] of an array ignoring `NaN` values and using a one-pass trial mean algorithm.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-array-nanstdevch.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-array-nanstdevch

[test-image]: https://github.com/stdlib-js/stats-array-nanstdevch/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-array-nanstdevch/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-array-nanstdevch/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-array-nanstdevch?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-array-nanstdevch.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-array-nanstdevch/main
...
[deno-url]: https://github.com/stdlib-js/stats-array-nanstdevch/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-array-nanstdevch/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-array-nanstdevch/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-array-nanstdevch/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-array-nanstdevch/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-array-nanstdevch/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-array-nanstdevch/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-array-nanstdevch/main/LICENSE
